...
2. **Create an 'assets' folder**: inside **main** on your 'src' directory from your android section
...
5. **Add Object Detection to your app**: once you see the default React Native welcome page on your device, change your **App.tsx** code to the following one
...
Always use the file that ends on '.xworkspace' on your xcode
